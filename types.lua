...
---@field target_effect fun(state: GameState, battle: BattleState, origin: Actor, target: Actor, scene_data: table)
---@field target_effect_on_kill (fun(state: GameState, battle: BattleState, origin: Actor, target: Actor, scene_data: table))?
---@field scene_update fun(state: GameState, battle: BattleState, time_passed: number, dt: number, origin: Actor, target: Actor, scene_data: table): boolean
---@field scene_render fun(state: GameState, battle: BattleState, time_passed: number, origin: Actor, target: Actor, scene_data: table)
---@field scene_on_start fun(state: GameState, battle: BattleState, origin: Actor, target: Actor, scene_data: table)
...
---@field name string
---@field description string
---@field on_kill_effect fun(state: GameState, battle: BattleState, origin: Actor, target: Actor)
---@field on_damage_dealt_effect fun(state: GameState, battle: BattleState, origin: Actor, target: Actor, damage_dealt: number)
---@field on_damage_received_effect fun(state: GameState, battle: BattleState, origin: Actor, target: Actor, damage_dealt: number)
---@field on_turn_start fun(state: GameState, battle: BattleState, origin: Actor)
